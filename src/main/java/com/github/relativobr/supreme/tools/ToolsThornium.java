...
public class ToolsThornium {
  ...
  public static final ItemStack[] RECIPE_THORNIUM_AXE = {SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeCetrus.CETRUS_VENTUS.asQuantity(1),
      null, SupremeComponents.THORNIUM_INGOT.asQuantity(1), SlimefunItems.STAFF_ELEMENTAL.asQuantity(1), null, null, SlimefunItems.STAFF_ELEMENTAL.asQuantity(1),
      null};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_PICKAXE = {SupremeComponents.THORNIUM_INGOT.asQuantity(1),
      SupremeCetrus.CETRUS_IGNIS.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), null, SlimefunItems.STAFF_ELEMENTAL.asQuantity(1), null, null,
      SlimefunItems.STAFF_ELEMENTAL.asQuantity(1), null};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_SHOVEL = {null, SupremeComponents.THORNIUM_INGOT.asQuantity(1), null, null,
      SupremeCetrus.CETRUS_AQUA.asQuantity(1), null, null, SlimefunItems.STAFF_ELEMENTAL.asQuantity(1), null};
