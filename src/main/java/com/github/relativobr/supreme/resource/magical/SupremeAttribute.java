...
public class SupremeAttribute {
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_MAGIC = {SupremeCetrus.CETRUS_LUX.asQuantity(1),
      SupremeCetrus.CETRUS_VENTUS.asQuantity(1), SupremeCetrus.CETRUS_LUX.asQuantity(1),
      SupremeCetrus.CETRUS_AQUA.asQuantity(1), new ItemStack(Material.NETHER_WART, 64),
      SupremeCetrus.CETRUS_AQUA.asQuantity(1), SupremeCore.CORE_OF_LIFE.asQuantity(1),
      SupremeCetrus.CETRUS_VENTUS.asQuantity(1), SupremeCore.CORE_OF_NATURE.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_BOMB = {SupremeCetrus.CETRUS_IGNIS.asQuantity(1),
      SupremeCore.CORE_OF_BLOCK.asQuantity(1), SupremeCetrus.CETRUS_IGNIS.asQuantity(1),
      SupremeCore.CORE_OF_BLOCK.asQuantity(1), new ItemStack(Material.GUNPOWDER, 64),
      SupremeCore.CORE_OF_BLOCK.asQuantity(1), SupremeCetrus.CETRUS_IGNIS.asQuantity(1),
      SupremeCore.CORE_OF_BLOCK.asQuantity(1), SupremeCetrus.CETRUS_IGNIS.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_FORTUNE = {new ItemStack(Material.DIAMOND_BLOCK, 64),
      ...
      new SlimefunItemStack(SupremeAttribute.getMagic().asQuantity(1), 1), SupremeCore.CORE_OF_ALLOY.asQuantity(1),
      new SlimefunItemStack(SupremeAttribute.getMagic().asQuantity(1), 1), new ItemStack(Material.OBSIDIAN, 64),
  ...
  public static final ItemStack[] RECIPE_ATTRIBUTE_IMPETUS = {new SlimefunItemStack(SupremeAttribute.getMagic().asQuantity(1), 1),
      new SlimefunItemStack(SupremeAttribute.getBomb().asQuantity(1), 1), SupremeCetrus.CETRUS_AQUA.asQuantity(1),
      SupremeCore.CORE_OF_DEATH.asQuantity(1), SupremeCetrus.CETRUS_IGNIS.asQuantity(1),
      SupremeCore.CORE_OF_DEATH.asQuantity(1), SupremeCetrus.CETRUS_VENTUS.asQuantity(1),
      new SlimefunItemStack(SupremeAttribute.getFortune().asQuantity(1), 1), SupremeCetrus.CETRUS_LUMIUM.asQuantity(1)};
