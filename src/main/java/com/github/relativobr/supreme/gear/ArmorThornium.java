...
public class ArmorThornium {
  ...
  public static final ItemStack[] RECIPE_THORNIUM_BOOTS = {null, null, null, SupremeCetrus.CETRUS_IGNIS.asQuantity(1), null,
      SupremeCetrus.CETRUS_IGNIS.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), null, SupremeComponents.THORNIUM_INGOT.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_CHESTPLATE = {SupremeComponents.THORNIUM_INGOT.asQuantity(1), null,
      SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeCetrus.CETRUS_LUMIUM.asQuantity(1),
      SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1),
      SupremeComponents.THORNIUM_INGOT.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_HELMET = {SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeCetrus.CETRUS_AQUA.asQuantity(1),
      SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), null, SupremeComponents.THORNIUM_INGOT.asQuantity(1), null,
      null, null};
  ...
  public static final ItemStack[] RECIPE_THORNIUM_LEGGINGS = {SupremeCetrus.CETRUS_VENTUS.asQuantity(1),
      SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeCetrus.CETRUS_VENTUS.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), null,
      SupremeComponents.THORNIUM_INGOT.asQuantity(1), SupremeComponents.THORNIUM_INGOT.asQuantity(1), null, SupremeComponents.THORNIUM_INGOT.asQuantity(1)};
