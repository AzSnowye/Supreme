...
public class MobTechCollectorMachineRecipe extends MachineRecipe implements Predicate<LivingEntity> {
  ...
  public MobTechCollectorMachineRecipe(SlimefunItemStack input, SlimefunItemStack result,
    ...
    super(15, new ItemStack[]{input.asQuantity(1)}, new ItemStack[]{result.asQuantity(1)});
  ...
  public static List<ItemStack> getAllRecipe() {
    ...
    if (supremeOptions.isMobTechEnableBee()) {
      ...
      displayRecipes.add(ItemUtil.buildItemFromMobTechDTO(BeeTech.SIMPLE_BEE, 0).asQuantity(1));
    }
    if (supremeOptions.isMobTechEnableIronGolem()) {
      ...
      displayRecipes.add(ItemUtil.buildItemFromMobTechDTO(IronGolemTech.SIMPLE_GOLEM, 0).asQuantity(1));
    }
    if (supremeOptions.isMobTechEnableZombie()) {
      ...
      displayRecipes.add(ItemUtil.buildItemFromMobTechDTO(ZombieTech.SIMPLE_ZOMBIE, 0).asQuantity(1));
    }
