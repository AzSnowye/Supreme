...
public class ForgeMagical extends SimpleItemWithLargeContainerMachine {
  ...
  public static final ItemStack[] RECIPE_FORGE_MAGICAL_MACHINE = new ItemStack[]{SupremeComponents.RUSTLESS_MACHINE.asQuantity(1),
      new ItemStack(Material.ENCHANTING_TABLE), SupremeComponents.RUSTLESS_MACHINE.asQuantity(1), SupremeComponents.INDUCTIVE_MACHINE.asQuantity(1),
      SupremeComponents.SYNTHETIC_RUBY.asQuantity(1), SupremeComponents.INDUCTIVE_MACHINE.asQuantity(1), SlimefunItems.ELECTRIC_GOLD_PAN_3.asQuantity(1),
      SlimefunItems.PROGRAMMABLE_ANDROID_3.asQuantity(1), SlimefunItems.ELECTRIC_ORE_GRINDER_3.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_FORGE_MAGICAL_MACHINE_II = new ItemStack[]{
      ...
      SupremeComponents.INDUCTOR_MACHINE.asQuantity(1), ForgeMagical.FORGE_MAGICAL_MACHINE.asQuantity(1), SupremeComponents.INDUCTOR_MACHINE.asQuantity(1),
      SupremeComponents.THORNERITE.asQuantity(1), SupremeCetrus.CETRUS_LUMIUM.asQuantity(1), SupremeComponents.THORNERITE.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_FORGE_MAGICAL_MACHINE_III = new ItemStack[]{SupremeComponents.THORNERITE.asQuantity(1),
      SupremeAttribute.getMagic().asQuantity(1), SupremeComponents.THORNERITE.asQuantity(1), SupremeComponents.SUPREME.asQuantity(1),
      ForgeMagical.FORGE_MAGICAL_MACHINE_II, SupremeComponents.SUPREME.asQuantity(1), SupremeComponents.CRYSTALLIZER_MACHINE.asQuantity(1),
