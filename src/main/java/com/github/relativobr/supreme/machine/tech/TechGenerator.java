...
public class TechGenerator extends SimpleItemContainerMachine implements Radioactive {
  ...
  public static void preSetup(Supreme plugin, SlimefunItemStack item, io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack input,
      io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack output) {
    preSetup(plugin, 1, item, input.item(), output.item());
  }
  ...
  public static void preSetup(Supreme plugin, int tierCard, SlimefunItemStack item, io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack input,
      io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack output) {
    preSetup(plugin, tierCard, item, input.item(), input.item(), output.item());
  }

  public static void preSetup(Supreme plugin, int tierCard, SlimefunItemStack item,
      io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack input1,
      io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack input2,
      io.github.thebusybiscuit.slimefun4.api.items.SlimefunItemStack output) {
    preSetup(plugin, tierCard, item, input1.item(), input2.item(), output.item());
  }
