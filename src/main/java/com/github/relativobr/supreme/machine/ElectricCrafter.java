...
public class ElectricCrafter extends GenericMachine {
  ...
  public static final ItemStack[] RECIPE_ELECTRIC_CRAFTER_MACHINE = new ItemStack[]{SupremeComponents.RUSTLESS_MACHINE.asQuantity(1),
      SlimefunItems.VANILLA_AUTO_CRAFTER.asQuantity(1), SupremeComponents.RUSTLESS_MACHINE.asQuantity(1), SupremeComponents.INDUCTIVE_MACHINE.asQuantity(1),
      SupremeComponents.SYNTHETIC_RUBY.asQuantity(1), SupremeComponents.INDUCTIVE_MACHINE.asQuantity(1), SupremeComponents.ADAMANTIUM_PLATE.asQuantity(1),
      SlimefunItems.ENHANCED_AUTO_CRAFTER.asQuantity(1), SupremeComponents.ADAMANTIUM_PLATE.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_ELECTRIC_CRAFTER_MACHINE_II = new ItemStack[]{
      SupremeComponents.CONVEYANCE_MACHINE.asQuantity(1), SupremeComponents.BLEND_MACHINE.asQuantity(1), SupremeComponents.CONVEYANCE_MACHINE.asQuantity(1),
      SupremeComponents.INDUCTOR_MACHINE.asQuantity(1), ElectricCrafter.ELECTRIC_CRAFTER_MACHINE.asQuantity(1), SupremeComponents.INDUCTOR_MACHINE.asQuantity(1),
      SupremeComponents.CRYSTALLIZER_MACHINE.asQuantity(1), SupremeCetrus.CETRUS_IGNIS.asQuantity(1), SupremeComponents.CRYSTALLIZER_MACHINE.asQuantity(1)};
  ...
  public static final ItemStack[] RECIPE_ELECTRIC_CRAFTER_MACHINE_III = new ItemStack[]{SupremeComponents.THORNERITE.asQuantity(1),
      SupremeCetrus.CETRUS_LUX.asQuantity(1), SupremeComponents.THORNERITE.asQuantity(1),      SupremeComponents.SUPREME.asQuantity(1), ElectricCrafter.ELECTRIC_CRAFTER_MACHINE_II, SupremeComponents.SUPREME.asQuantity(1), SupremeComponents.CRYSTALLIZER_MACHINE.asQuantity(1),
  ...
  public static final AbstractItemRecipe RECIPE_BATTERY = new AbstractItemRecipe(
      new ItemStack[]{SlimefunItems.ZINC_INGOT.asQuantity(1), SlimefunItems.SULFATE.asQuantity(1),
          SlimefunItems.COPPER_INGOT.asQuantity(1), SlimefunItems.ZINC_INGOT.asQuantity(1),
          SlimefunItems.SULFATE.asQuantity(1), SlimefunItems.COPPER_INGOT.asQuantity(1),
          new ItemStack(Material.REDSTONE), null, null}, SlimefunItems.BATTERY.asQuantity(1));
