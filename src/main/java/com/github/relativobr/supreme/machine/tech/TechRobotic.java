...
public class TechRobotic extends SimpleItemContainerMachine implements Radioactive {
  ...
  public static final SlimefunItemStack TECH_ROBOTIC = new SupremeItemStack("SUPREME_TECH_ROBOTIC",
      ...
      "&3Supreme Machine");
  public static final ItemStack[] RECIPE_TECH_ROBOTIC = {SupremeComponents.INDUCTIVE_MACHINE.asQuantity(1),
      ...
      SlimefunItems.ELECTRIC_MOTOR.asQuantity(1), SlimefunItems.REINFORCED_PLATE.asQuantity(1), SupremeComponents.RUSTLESS_MACHINE.asQuantity(1),
      SupremeCore.CORE_OF_BLOCK.asQuantity(1), SupremeComponents.RUSTLESS_MACHINE.asQuantity(1)};
  ...
  public static final SlimefunItemStack TECH_ROBOTIC_II = new SupremeItemStack("SUPREME_TECH_ROBOTIC_II",
      ...
      LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), UtilEnergy.energyPowerPerSecond(500), "",
      "&3Supreme Machine");
  public static final ItemStack[] RECIPE_TECH_ROBOTIC_II = new ItemStack[]{SupremeComponents.CONVEYANCE_MACHINE.asQuantity(1),
      ...
      TechRobotic.TECH_ROBOTIC.asQuantity(1), SupremeComponents.INDUCTOR_MACHINE.asQuantity(1), SupremeComponents.THORNERITE.asQuantity(1),
  ...
  public static final SlimefunItemStack TECH_ROBOTIC_III = new SupremeItemStack("SUPREME_TECH_ROBOTIC_III",
      ...
      LoreBuilder.machine(MachineTier.END_GAME, MachineType.MACHINE), UtilEnergy.energyPowerPerSecond(500), "",
      "&3Supreme Machine");
  public static final ItemStack[] RECIPE_TECH_ROBOTIC_III = new ItemStack[]{SupremeComponents.THORNERITE.asQuantity(1),
      ...
      TechRobotic.TECH_ROBOTIC_II, SupremeComponents.SUPREME.asQuantity(1), SupremeComponents.CRYSTALLIZER_MACHINE.asQuantity(1),
